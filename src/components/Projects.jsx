...
const Projects = () => {
  return (
    <section id="projects">
      <h2 className="text-center text-5xl font-bold leading-130 font-montserrat text-yellow-100 md:text-6xl ">
        our projects
      </h2>
      <p className="text-center  text-black-200 font-montserrat text-base leading-180 md:text-2xl">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between md:mx-16">
        ...
        <div className="md:w-1/2">
          <ProjectCard
            ...
            link="https://www.solardosbicos.pt/"
      ...
      {/* second section */}
      <div className="flex flex-col md:flex-row items-center justify-between md:px-16  ">
        <div className=" md:w-1/2  order-2 md:order-1">
          <ProjectCard
            type="WEBSITE"
            title="www.financebdarija.co"
            link="https://financebdarija.netlify.app"
