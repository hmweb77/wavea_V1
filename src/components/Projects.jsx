...
const Projects = () => {
  return (
    <section id='projects'>
      ...
      {/* first section */}
      <div className='flex flex-col md:flex-row items-center justify-between  md:text-left '>
      ...
      <div className='flex flex-col md:flex-row items-center justify-between '>
        <div className="w-full md:w-1/2 text-center order-2 md:order-1  md:text-left ">
          <ProjectCard type="WEBSITE"
